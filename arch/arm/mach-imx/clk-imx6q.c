...
static void __init imx6q_clocks_init(struct device_node *ccm_node)
{
	...
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_HDMI_IPU2_DI0)
		3 << CCM_CCGR_OFFSET(2) |	/* hdmi_tx_isfrclk */
		3 << CCM_CCGR_OFFSET(0) |	/* hdmi_tx_iahbclk */
#endif
	...
	writel_relaxed(1 << CCM_CCGR_OFFSET(13) |
		...
		/*
		 * Enable ipu1_clk, ipu1_di0_clk and ldb_di0_clk
		 * to keep the display running.
		 */
		3 << CCM_CCGR_OFFSET(6) |	/* ldb_di0_clk */
		3 << CCM_CCGR_OFFSET(1) |	/* ipu1_di0_clk */
		3 << CCM_CCGR_OFFSET(0) |	/* ipu1_clk */
#endif

#ifdef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU1_DI1
		/*
		 * Enable ipu1_clk, ipu1_di1_clk and ldb_di1_clk
		 * to keep the display running.
		 */
		3 << CCM_CCGR_OFFSET(7) |	/* ldb_di1_clk */
		3 << CCM_CCGR_OFFSET(2) |	/* ipu1_di1_clk */
		3 << CCM_CCGR_OFFSET(0) |	/* ipu1_clk */
#endif

#ifdef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU2_DI1
		/*
		 * Enable ipu2_clk, ipu2_di1_clk and ldb_di1_clk
		 * to keep the display running.
		 */
		3 << CCM_CCGR_OFFSET(7) |	/* ldb_di1_clk */
		3 << CCM_CCGR_OFFSET(5) |	/* ipu2_di1_clk */
		3 << CCM_CCGR_OFFSET(3) |	/* ipu2_clk */
#endif

#if defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LCD_IPU1_DI0) || \
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_HDMI_IPU1_DI0)
		/*
		 * Enable ipu1_di0_clk and ipu1_clk 
		 * to keep the display running.
		 */
		3 << CCM_CCGR_OFFSET(1) |	/* ipu1_di0_clk */
		3 << CCM_CCGR_OFFSET(0) |	/* ipu1_clk */
		...
		/*
		 * Enable ipu2_di0_clk and ipu2_clk
		 * to keep the display running.
		 */
		3 << CCM_CCGR_OFFSET(4) |	/* ipu2_di0_clk */
		3 << CCM_CCGR_OFFSET(3) |	/* ipu2_clk */
#endif
	...
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU1_DI1) || \
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU2_DI1)
	/* Keep pll2_pfd0_352M, as it is the LVDS clock root */
	if (cpu_is_imx6dl())
		reg |= 0x80008000;
	else
		reg |= 0x80808000;
	...
	/* Keep pll3_pfd1_540M, as it is the IPU clock root in iMX6DL */
	if (cpu_is_imx6dl())
		reg |= 0x80800080;
	else
		reg |= 0x80808080;
	...
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_HDMI_IPU1_DI0) || \
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_HDMI_IPU2_DI0)
	/* Keep PLL5 on for LCD and HDMI display */
#else
...
#ifdef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU1_DI0
	imx_clk_set_parent(clk[ipu1_di0_sel], clk[ldb_di0]);
	imx_clk_set_parent(clk[ipu1_di1_sel], clk[ipu1_di1_pre]);
	imx_clk_set_parent(clk[ipu2_di0_sel], clk[ipu2_di0_pre]);
	imx_clk_set_parent(clk[ipu2_di1_sel], clk[ipu2_di1_pre]);
#endif
...
#ifdef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU1_DI1
	imx_clk_set_parent(clk[ipu1_di0_sel], clk[ipu1_di0_pre]);
	imx_clk_set_parent(clk[ipu1_di1_sel], clk[ldb_di1]);
	imx_clk_set_parent(clk[ipu2_di0_sel], clk[ipu2_di0_pre]);
	imx_clk_set_parent(clk[ipu2_di1_sel], clk[ipu2_di1_pre]);
#endif
...
#ifdef CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU2_DI1
	imx_clk_set_parent(clk[ipu1_di0_sel], clk[ipu1_di0_pre]);
	imx_clk_set_parent(clk[ipu1_di1_sel], clk[ipu1_di0_pre]);
	imx_clk_set_parent(clk[ipu2_di0_sel], clk[ipu2_di0_pre]);
	imx_clk_set_parent(clk[ipu2_di1_sel], clk[ldb_di1]);
#endif
	...
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU1_DI1) || \
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_HDMI_IPU1_DI0)
	imx_clk_prepare_enable(clk[ipu1]);
#endif

#if defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_LVDS_IPU2_DI1) || \
	defined(CONFIG_MX6_CLK_FOR_BOOTUI_TRANS_HDMI_IPU2_DI0)
	imx_clk_prepare_enable(clk[ipu2]);
#endif
#endif
}
