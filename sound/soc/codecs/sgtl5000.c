...
static int sgtl5000_set_dai_fmt(struct snd_soc_dai *codec_dai, unsigned int fmt)
{
	...
	u16 i2sctl = 0;
	printk("EPT:***********************sgtl5000_set_dai_fmt!!!\n");
	sgtl5000->master = 0;
	/*
				  ...
				  struct snd_soc_dai *dai)
{
	...
	printk("EPT:***********************sgtl5000_pcm_hw_params!!!\n");
...
static int sgtl5000_probe(struct snd_soc_codec *codec)
{
	...
	pr_info("sgtl5000_probe 1\n ");
	ret = sgtl5000_enable_regulators(codec);
	if (ret)
		return ret;

	pr_info("sgtl5000_probe 2\n ");
	/* power up sgtl5000 */
...
//snd_soc_write(codec, SGTL5000_CHIP_SSS_CTRL, 0x70);
	...
	snd_soc_write(codec, SGTL5000_CHIP_ANA_CTRL,
			SGTL5000_HP_ZCD_EN |
			SGTL5000_ADC_ZCD_EN);
//snd_soc_write(codec, SGTL5000_CHIP_ANA_CTRL,0x00);
