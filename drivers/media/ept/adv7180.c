...
{
	dev_dbg(&adv7180_data.i2c_client->dev, "adv7180:ioctl_g_ifparm\n");
...
{
	struct adv7180_sensor_data *sensor = s->priv;

	dev_dbg(&adv7180_data.i2c_client->dev, "adv7180:ioctl_s_power\n");
...
static int ioctl_g_fmt_cap(struct v4l2_int_device *s, struct v4l2_format *f)
{
	...
	dev_dbg(&adv7180_data.i2c_client->dev, "adv7180:ioctl_g_fmt_cap\n");
			   ...
			   struct v4l2_queryctrl *qc)
{
	...
	dev_dbg(&adv7180_data.i2c_client->dev, "adv7180:ioctl_queryctrl\n");
...
static int ioctl_g_ctrl(struct v4l2_int_device *s, struct v4l2_control *vc)
{
	...
	case V4L2_CID_BRIGHTNESS:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_BRIGHTNESS\n");
		adv7180_data.priv.brightness = adv7180_read(ADV7180_BRIGHTNESS);
		vc->value = adv7180_data.priv.brightness;
		break;
	case V4L2_CID_CONTRAST:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_CONTRAST\n");
		vc->value = adv7180_data.priv.contrast;
		break;
	case V4L2_CID_SATURATION:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_SATURATION\n");
		sat = adv7180_read(ADV7180_SD_SATURATION_CB);
		adv7180_data.priv.saturation = sat;
		vc->value = adv7180_data.priv.saturation;
		break;
	case V4L2_CID_HUE:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_HUE\n");
		vc->value = adv7180_data.priv.hue;
		break;
	case V4L2_CID_AUTO_WHITE_BALANCE:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_AUTO_WHITE_BALANCE\n");
		break;
	case V4L2_CID_DO_WHITE_BALANCE:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_DO_WHITE_BALANCE\n");
		break;
	case V4L2_CID_RED_BALANCE:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_RED_BALANCE\n");
		vc->value = adv7180_data.priv.red;
		break;
	case V4L2_CID_BLUE_BALANCE:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_BLUE_BALANCE\n");
		vc->value = adv7180_data.priv.blue;
		break;
	case V4L2_CID_GAMMA:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_GAMMA\n");
		break;
	case V4L2_CID_EXPOSURE:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_EXPOSURE\n");
		vc->value = adv7180_data.priv.ae_mode;
		break;
	case V4L2_CID_AUTOGAIN:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_AUTOGAIN\n");
		break;
	case V4L2_CID_GAIN:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_GAIN\n");
		break;
	case V4L2_CID_HFLIP:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_HFLIP\n");
		break;
	case V4L2_CID_VFLIP:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_VFLIP\n");
		break;
	default:
		dev_dbg(&adv7180_data.i2c_client->dev,"   Default case\n");
		vc->value = 0;
		ret = -EPERM;
		break;
	}
...
static int ioctl_s_ctrl(struct v4l2_int_device *s, struct v4l2_control *vc)
{
	...
	case V4L2_CID_BRIGHTNESS:
		...
		adv7180_data.priv.brightness = vc->value;
		break;
	case V4L2_CID_CONTRAST:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_CONTRAST\n");
		break;
	case V4L2_CID_SATURATION:
		...
		adv7180_data.priv.saturation = vc->value;
		break;
	case V4L2_CID_HUE:
		dev_dbg(&adv7180_data.i2c_client->dev,"   V4L2_CID_HUE\n");
		break;
...
{
	dev_dbg(&adv7180_data.i2c_client->dev, "adv7180:ioctl_dev_init\n");
	return 0;
}
